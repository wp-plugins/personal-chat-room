...
class CMySQL {
	...
	// constructor
    function CMySQL() {
		//$this->aArray = get_option('chat_lord_linus_database');
		$this->sDbHost = $GLOBALS['MySQL']->sDbHost;
        $this->sDbName = $GLOBALS['MySQL']->sDbName;
        $this->sDbUser = $GLOBALS['MySQL']->sDbUser;
        $this->sDbPass = $GLOBALS['MySQL']->sDbPass;
		// create db link
        $this->vLink = mysql_connect($this->sDbHost, $this->sDbUser, $this->sDbPass);
		//echo $this->sDbHost;
        //select the database
