...
Personal chat room adds a button to chat live from your website, for that your customers have to just join with this application
...
3. save your database configuration using dashboard
